...
class UserManager(BaseUserManager):
    def create_user(self, username, email, password=None, referral_token=None, phone=None):
        ...
        if not usages_token:
            ...
            # create for new user 5 referall code (for frends)
            for i in range(5):
    ...
    def create_superuser(self, username, email, password=None, referral_token=None, phone=None):
